    ...
    return (
        <article className={cn('companion-list', classNames)}>
            ...
            <Table className="w-full">
                ...
                <TableHeader >
                    <TableRow>
                        <TableHead className="text-lg w-2/3 px-8 py-4">Lessons </TableHead>
                        <TableHead className="text-lg px-16 py-4">Subjects</TableHead>
                        <TableHead className="text-lg text-right px-8 py-4">Duration</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {companions?.map(({ id, subject, name, topic, duration}) => (
                        <TableRow key={id}>
                            ...
                            <TableCell className="px-8">
                                <div className="items-center flex w-full justify-end gap-2">
